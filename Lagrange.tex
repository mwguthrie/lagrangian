...
If $T=T(x)$ denotes temperature in the first coordinate system then as an analog to definition \ref{lagrangian-transform} we define the temperature in the second coordinate system by
