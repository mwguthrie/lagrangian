...
The arc length $S$ of a function $y(x)$ \footnote{Our choices $x$ and $y$ for the abstract formulation of the Lagrangian do not mean the normal $(x,y)$ Euclidean coordinates beloved by physicists. We are saying that some function $y$, whatever it may be, can be parameterized by a variable $x$.} between two points $(x_1,y_1)$ and $(x_2,y_2)$ is given by
